...
function getBoardState() {
  ...
  // $ is an identifier that identifies an object in the same way a name would.
  // The objects they identify include things
  // such as variables, functions, properties, events, and object
